...
<body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
          ...
          <div class="content-wrapper">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">{{ $nombreReservations }}</h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Nombre de réservations</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0" style="font-size:1.4rem;">{{ number_format($chiffreAffaires, 2, ',', ' ') }}MAD</h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Chiffre d'affaires</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0" style="font-size:1.4rem;">{{ number_format($revenuMoyenParVoyageur, 2, ',', ' ') }} MAD</h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Revenu moyen par voyageur</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">{{$totalVoyageurs}}</h3>
                          <p class="text-success ml-2 mb-0 font-weight-medium">+3.5%</p>
                        </div>
                      </div>
                      <div class="col-3">
                    ...
                    <h6 class="text-muted font-weight-normal">Nombre de voyageurs</h6>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                     ...
                     @foreach($payments as $payment)
                      <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                        <div class="text-md-center text-xl-left">
                          <h6 class="mb-1">Transfert vers {{ $payment->type_paiement === 'paypal' ? 'Paypal' : 'CIHBANK' }}</h6>
                          <p class="text-muted mb-0">{{$payment->date_reservation}}</p>
                        </div>
                        <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                          <h6 class="font-weight-bold mb-0">{{$payment->voyage->prix}}MAD</h6>
                        </div>
                      </div>
                     @endforeach
                    <!-- <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                        <h6 class="mb-1">Transfert vers Paypal</h6>
                    ...
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                        <h6 class="mb-1">Virement à CIH BANK</h6>
                        <p class="text-muted mb-0">07 Jan 2019, 09:12AM</p>
                      </div>
                      <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-row justify-content-between">
                      <h4 class="card-title mb-1">6 Derniers vols</h4>
                      <p class="text-muted mb-1">Votre statut de données</p>
                    </div>
                    <div class="row">
                      <div class="col-12">
                        <div class="preview-list">
                          @foreach ($reservations as $reservation)
                              @php
                                  $nomVoyage = $reservation->voyage->ville_depart . ' - ' . $reservation->voyage->ville_arrivee;
                                  $nomVoyageur = $reservation->passenger->nom_passeng . ' ' . $reservation->passenger->prenom_passeng;
                                  $duree = $reservation->voyage->duree;
                                  $nombreAdultes = $reservation->nombre_adultes;
                                  $nombreEnfants = $reservation->nombre_enfants;
                                  $typeVoyage = $reservation->voyage->type_voyagep;

                                  // Définir icône et couleur selon le type
                                  $icone = $typeVoyage === 'Voyage Personnelle' ? 'fa-users' : 'fa-user';
                                  $couleur = $typeVoyage === 'Voyage Personnelle' ? 'bg-success' : 'bg-primary';
                              @endphp
                              <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <div class="preview-icon {{ $couleur }}">
                                        <i class="fa-solid {{ $icone }}"></i>
                                    </div>
                                </div>
                                <div class="preview-item-content d-sm-flex flex-grow">
                                    <div class="flex-grow">
                                        <h6 class="preview-subject">{{ $nomVoyage }}</h6>
                                        <p class="text-muted mb-0">{{ $nomVoyageur }}</p>
                                    </div>
                                    <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                        <p class="text-muted">{{ $duree }}</p>
                                        <p class="text-muted mb-0">{{ $nombreAdultes }} Adultes, {{ $nombreEnfants }} Enfants</p>
                                    </div>
                                </div>
                            </div>
                          @endforeach
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                          <h2 class="mb-0"  style="font-size: 1.575rem;">{{ number_format($revenu, 2, ',', ' ') }} MAD</h2>
                          <p class="text-success ml-2 mb-0 font-weight-medium">+3.5%</p>
                        </div>
                        <h6 class="text-muted font-weight-normal">11.38% Depuis la semaine dernière</h6>
                      </div>
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                      <i class="fa-solid fa-sack-dollar" style="color:rgb(15, 66, 233);font-size: 2.75rem;margin-bottom: 18px;"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        ...
                        <h6 class="text-muted font-weight-normal"> 9.61% Depuis l'année dernière</h6>
                      </div>
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                        <i class="icon-lg mdi mdi-wallet-travel text-danger ml-auto" style="display:none"></i>
                      <i class="fa-solid fa-user-tie" style="color: #fb1c32;font-size: 2.85rem;margin-right:6px"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        ...
                        <h6 class="text-muted font-weight-normal">2.27% Depuis l'année dernière</h6>
                      </div>
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                      <i class="fa-solid fa-handshake" style="color:rgb(13, 156, 44);font-size: 2.85rem;;margin-right:6px"></i>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <img src="style/assets/images/faces/face1.jpg" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="style/assets/images/faces/face2.jpg" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="style/assets/images/faces/face5.jpg" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="style/assets/images/faces/face3.jpg" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="style/assets/images/faces/face4.jpg" alt="image" />
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="preview-list">
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="style/assets/images/faces/face6.jpg" alt="image" class="rounded-circle" />
                        </div>
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="style/assets/images/faces/face8.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="style/assets/images/faces/face9.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="style/assets/images/faces/face11.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel" id="owl-carousel-basic">
                      <div class="item">
                        <img src="style/assets/images/dashboard/Rectangle.jpg" alt="">
                      </div>
                      <div class="item">
                        <img src="style/assets/images/dashboard/Img_5.jpg" alt="">
                      </div>
                      <div class="item">
                        <img src="style/assets/images/dashboard/img_6.jpg" alt="">
                      </div>
                    </div>
                    <div class="d-flex py-4">
                      <div class="preview-list w-100">
                        <div class="preview-item p-0">
                          <div class="preview-thumbnail">
                            <img src="style/assets/images/faces/face12.jpg" class="rounded-circle" alt="">
                          </div>
                          <div class="preview-item-content d-flex flex-grow">
                            <div class="flex-grow">
                              <div class="d-flex d-md-block d-xl-flex justify-content-between">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Visiteurs par nationalité</h4>
                    <div class="row">
                      <div class="col-md-5">
                        <div class="table-responsive">
                          <table class="table">
        ...
        <div class="main-panel" id="demo2" style="display:none">
          <div class="content-wrapper" style="height:100vh">
            <div class="page-header">
              <h3 class="page-title"> Les Voles </h3>
            </div>
            <div class="row" style="display: block;">
              <div class="col-md-6 grid-margin stretch-card" style="max-width:100%;">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Statut des vols</h4>
                    <div class="table-responsive">
                      <table class="table">
                        <thead>
                          <tr>
  ...
  <script>
    ...
    const demo2 = document.getElementById('demo2');e
    const state = localStorage.getItem('divState');
    ...
    link.addEventListener('click', function (e) {
      ...
      // Cacher demo1, afficher demo2
      demo1.style.display = 'none';
      demo2.style.display = 'block';

      // Sauvegarder l'état
      localStorage.setItem('divState', 'demo2');
    });
  });
  </script>
</html>